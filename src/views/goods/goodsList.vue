...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      jumpGoodsDetails(e) {
          //获取添加点击事件的子元素id
          var goodsId = e.currentTarget.firstChild.getAttribute('id')
          this.$router.push({name:'GoodsDetails',params:{goodsId: goodsId}})
      }
    },
